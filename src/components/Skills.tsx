...
const skills = ["React", "TypeScript", "Node.js", "MongoDB", "GraphQL", "Tailwind CSS", "Next.js", "Express", "Git", "Docker", "AWS", "Redux"];
const Skills = () => {
  return <section id="skills" className="py-20 bg-primary/50">
